# 🛡️ NeMo Guardrails & Observability Webinar Project

![Python](https://img.shields.io/badge/Python-3.8%2B-blue?logo=python&logoColor=white)
![Streamlit](https://img.shields.io/badge/Streamlit-App-FF4B4B?logo=streamlit&logoColor=white)
![NeMo Guardrails](https://img.shields.io/badge/NeMo-Guardrails-76B900)
![Logfire](https://img.shields.io/badge/Pydantic-Logfire-e92063)

Welcome to the **NeMo Guardrails Webinar** project! This repository demonstrates how to build safe, professional, and observable AI chatbots using NeMo Guardrails and Pydantic Logfire.
...
## Logging and Observability with Pydantic Logfire

We have integrated **Pydantic Logfire** to provide deep observability and logging for your RAG (Retrieval-Augmented Generation) applications. This allows you to easily trace requests, monitor performance, and debug issues.

**How to use it:**
1. In the application, locate the **Pydantic Logfire API Key** input field.
2. Enter your valid Logfire API Key.
3. Head over to your [Pydantic Logfire Dashboard](https://logfire.pydantic.dev/) to instantly view real-time logs, traces, and metrics generated by the application.
